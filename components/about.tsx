          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-lg text-muted-foreground mb-6">
                ...
                Annaba. With a strong foundation in modern web technologies, I specialize in creating scalable and
                user-friendly applications.
              </p>
              <p className="text-lg text-muted-foreground mb-6">
                My experience includes developing comprehensive booking systems, ridesharing platforms, and various web
                applications using cutting-edge technologies like Next.js, TypeScript, and MongoDB.
              </p>
              <p className="text-lg text-muted-foreground">
                When I'm not coding, you'll find me exploring the outdoors through hiking and camping, playing sports,
                or diving into the latest gaming adventures.
              </p>
            </div>
